<article id="post-<?php the_ID(); ?>" <?php post_class('group'); ?>>
	<div class="post-inner post-hover">
		...
		<div class="post-meta group">
			...
			<ul>
      		<li><?php get_template_part('parts/post-list-author-date'); ?><i class="fa fa-calendar" style="margin-left: 5px;"></i></li>
      		<li><p class="post-category">Categoria: <?php the_category(' , '); ?></p></li>
      		</ul>
		</div><!--/.post-meta-->
