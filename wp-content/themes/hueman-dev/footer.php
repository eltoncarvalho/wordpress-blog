    ...
    <section class="container" id="footer-bottom">
      <div class="container-inner">
        ...
        <div class="pad group">
          ...
          <div class="grid one-half" style="    margin-right: -6.2%; margin-top: 50px;">
            ...
            <?php if ( false !== $_footer_logo_img_src && ! empty($_footer_logo_img_src) ) : ?>
              <img align="center" id="footer-logo" src="<?php echo $_footer_logo_img_src; ?>" alt="<?php get_bloginfo('name'); ?>">
            <?php endif; ?>
          </div><br>
          Made with ♥ by <a href="http://eltoncarvalho.esy.es/">Elton Carvaho</a>
          <div id="copyright">
            ...
            <?php else : //if not customizing, display an empty p for design purposes ?>
                <?php if ( hu_user_can_see_customize_notices_on_front() ) : ?>
                    <?php
                      echo '<p style="text-transform:none;text-align: right;">',
                          __('Made with ♥ by <a href="http://eltoncarvalho.esy.es/">Elton Carvalho</a></p>', 'hueman');
                    ?>
                <?php endif; ?>
            <?php endif; ?>
          </div><!--/#copyright-->
